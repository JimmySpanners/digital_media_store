...
import type { ProductPackageLeftSection as ProductPackageLeftSectionType } from "@/app/custom_pages/types/sections";
import MediaLibrary from "@/components/media/MediaLibrary";
import { MediaLightbox } from "@/app/custom_pages/components/sections/MediaLightbox";

interface Props {
  section: ProductPackageLeftSectionType;
  isEditMode: boolean;
  onSectionChangeAction: (section: ProductPackageLeftSectionType) => void;
}

export function ProductPackageLeftSection({ section, isEditMode, onSectionChangeAction }: Props) {
