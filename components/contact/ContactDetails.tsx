    ...
    <section className="py-16">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className={cn("relative h-64 md:h-80 lg:h-96 rounded-2xl overflow-hidden", {
        ...
        >
          <ContactEditableMedia
            ...
            width={160}
            height={160}
            className="rounded-full w-40 h-40 object-cover border-4 border-pink-200 shadow-lg"
