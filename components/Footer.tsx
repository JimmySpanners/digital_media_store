    ...
    <footer className="w-full bg-gray-900 text-white">
      <div className="w-full px-6 py-8 md:px-8 lg:px-12 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Brand */}
          <div>
            <h3 className="text-xl font-bold mb-2">Digital Media Store</h3>
            <p className="text-gray-400 text-sm mb-3">
              Our one page digital media store.
            </p>
        ...
        <div className="border-t border-gray-800 mt-6 pt-4 text-center text-gray-400 text-sm">
          <p>&copy; {currentYear} Digital Media Store. All rights reserved. Made with <Heart className="inline h-3.5 w-3.5 text-rose-500 -mt-0.5" /> in West Yorkshire, UK</p>
        </div>
      </div>
    </footer>
  )
