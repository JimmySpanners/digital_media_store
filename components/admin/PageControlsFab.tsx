...
import { Settings, Save, Eye, Plus, X, ChevronUp, ChevronDown, Image, Video, FileText, Type } from "lucide-react";
...
export default function PageControlsFab({
  ...
  const sectionTypes = [
    { type: 'editable-title', label: 'Section Title', icon: <Type className="w-4 h-4 mr-2" /> },
    { type: 'hero', label: 'Hero Section' },
    { type: 'hero-responsive', label: 'Hero Section (Responsive)' },
    { type: 'slider', label: 'Slider Section' },
    { type: 'advanced-slider', label: 'Advanced Slider Section' },
